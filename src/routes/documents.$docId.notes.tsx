...
function DocumentNotesPage() {
  ...
  // Real, reported gap: regenerating replaced the notes with no way to
  // keep a copy of the version being replaced — every other AI-generated
  // artifact in this app (summary, quiz, flashcards) already has a
  // share/download action; this was the one exception. Same
