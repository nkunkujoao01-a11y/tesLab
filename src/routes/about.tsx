      ...
      <div className="mx-auto max-w-[680px] px-6 pb-24 pt-10 lg:pt-14">
        ...
        <div className="mt-8 rounded-2xl bg-card p-6 ring-1 ring-border/60 lg:p-8">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="mt-4 inline-flex items-center gap-2 rounded-lg bg-prestige-deep px-4 py-2 text-xs font-semibold text-prestige-cream transition-all active:scale-[0.97]"
          >
