    ...
    <MobileShell>
      ...
      <div className="grid gap-8 px-6 lg:grid-cols-[minmax(0,1fr)_360px] lg:gap-10 lg:px-10 lg:pb-16">
        <div className="space-y-8">
           ...
           * here since this is where model management already lives, not
           * proof a crash definitely happened (closing the tab on purpose
           * mid-operation leaves the same trace). */}
          {staleAiOperation && (
          ...
          <section className="animate-rise rounded-2xl bg-card p-6 ring-1 ring-border/60 lg:p-8">
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0">
                <p className="text-sm font-medium text-prestige-deep">AI summarization model</p>
              ...
              {modelStatus === "ready" ? (
                <div>
                  <div className="flex items-center gap-2 text-xs font-medium text-prestige-mid">
                    ...
                    Downloaded &middot; used automatically for new summaries
                  </div>
                  {/* Surfaced right here, at the point of completion — not
                   * only later on a different page, which used to be the
                   * only place this was ever mentioned. A real, caught
                   * Cache API failure can leave a download working for the
                   * rest of this session but not actually saved for next
                   * time, with nothing otherwise admitting that. */}
                  {!modelOfflineCapable && (
              ...
              {chatModelStatus === "ready" ? (
                ...
                <div>
                  {chatModelChoice === "gemma3-1b" ? (
                    ...
                    // real-device testing — the download itself has taken
                    // a whole device down before, not just failed cleanly.
